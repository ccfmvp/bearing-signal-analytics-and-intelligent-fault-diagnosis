...
for train_index, val_index in kf.split(X_scaled, y_encoded):
    ...
    report_df.to_csv(f'result/CNN23/fold_{fold}_classification_report.csv')
    ...
    cm_df.to_csv(f'result/CNN23/fold_{fold}_confusion_matrix.csv')
    ...
    plt.tight_layout()
    plt.savefig(f'result/CNN23/fold_{fold}_metrics.png', dpi=150)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(f'result/CNN23/fold_{fold}_confusion_matrix.png', dpi=150)
    plt.show()
...
plt.tight_layout()
plt.savefig('result/CNN23/all_folds_metrics_summary.png', dpi=150, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('result/CNN23/all_folds_confusion_matrix_summary.png', dpi=150, bbox_inches='tight')
plt.show()
