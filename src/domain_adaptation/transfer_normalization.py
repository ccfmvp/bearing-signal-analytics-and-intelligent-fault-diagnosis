...
if __name__ == "__main__":
    # 执行归一化
    normalized_data = normalize_csv_file("solving_original_data.csv", "final_original_data.csv")
    normalized_data = normalize_csv_file("solving_target_data.csv", "final_target_data.csv")
