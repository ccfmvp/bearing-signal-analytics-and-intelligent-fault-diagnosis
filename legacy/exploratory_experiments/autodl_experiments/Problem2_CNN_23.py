...
for train_index, val_index in kf.split(X_scaled, y_encoded):
    ...
    report_df.to_csv(f'CNN23/fold_{fold}_classification_report.csv')
    ...
    cm_df.to_csv(f'CNN23/fold_{fold}_confusion_matrix.csv')
    ...
    plt.tight_layout()
    plt.savefig(f'CNN23/fold_{fold}.png', dpi=150)
    plt.show()
